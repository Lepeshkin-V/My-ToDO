...
export class TablesController {
  ...
  @UseGuards(JwtAuthGuard)
  @Get(':id/notes/week')
  async getWeek(@Param('id') tableId: string, @Query('date') date: string): Promise<Note[]> {
  ...
  @UseGuards(JwtAuthGuard)
  @Get(':id/notes/day')
  async getDay(@Param('id') tableId: string, @Query('date') date: string): Promise<Note[]> {
  ...
  @UseGuards(JwtAuthGuard)
  @Patch(':id')
  async update(@Param('id') tableId: string, @Body() input: UpdateTableDto): Promise<Table> {
